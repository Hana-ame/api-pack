  ...
  function initFloatingNotice() {
    ...
    div.innerHTML = `
            ...
            <div style="padding: 10px; font-size: 14px;">
                ...
                <p>https://opencode.ai/go?ref=G7T0RKWR9N<br>支付宝可订阅，5刀首月，得60刀tokens<br>发我订阅截图（<a href="https://chatto.moonchan.xyz" style="color:#0066cc;">在chatto群发我截图</a>），视为对服务器捐赠5刀。</p>
            </div>
        `;
